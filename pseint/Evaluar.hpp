...
DataValue Evaluar(RunTime &rt, const string &expresion, int &p1, int &p2, const tipo_var &forced_tipo=vt_desconocido, const char *desc=nullptr);
DataValue Evaluar(RunTime &rt, string expresion, const tipo_var &forced_tipo=vt_desconocido);
DataValue EvaluarSC(RunTime &rt, string expresion, const tipo_var &forced_tipo=vt_desconocido, const char *desc=nullptr);
